...
class SessionClass
{
	...
	{
		$_ = new ArrayClass($_SESSION); return($_->exists($index));
	}
	...
	{
		session_regenerate_id(); return $this;
	}
	...
	{
		StaticAClass::add($key, $value, $_SESSION); return $this;
	}

	function del($key): SessionClass
	{
		StaticAClass::del($key, $_SESSION); return $this;
	}
}
?>