...
$required = [
 ...
 "birthmonth", "birthday", "phonecodeid", "phonenumber",
 "signupemail", "signupemailc", "signuppassword", "signuppasswordc"];

if (boolval (array_diff ($required, array_keys (__('request')->getPosts()->inputArray())))) {
...
// form.birthday
$months = [31, 29, 31, 30, 31, 30, 31, 30, 31, 30, 31, 30];
$birthdate = '';
